...
class XMPHandlerMixin(object):

	@classmethod
	def _load_annotations(cls, xmp_file):
		"""
					...
					for annotation in data[annotatorID][str(metadata_type)]:
						...
						if annotation.has_key("location"):
							...
							if isinstance(loc, list):
								cls._unicodeListToBuiltInList(loc)
							else:
								loc = cls._unicodeToBuiltInType(loc)
	...
	@classmethod
	def _save_annotations(cls, xmp_file, annotations):
		"""
