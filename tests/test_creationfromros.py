...
from qidata.tools.datasetfromrosbag import makeQiDataSetFromROSbag

# Test
from conftest import sandboxed, ROSBAG_ASUS, ROSBAG_STEREO

def test_create_dataset_from_rosbag():
	rosbag = sandboxed(ROSBAG_ASUS)
	output_ds = os.path.splitext(rosbag)[0]
	makeQiDataSetFromROSbag(rosbag,
	    {
